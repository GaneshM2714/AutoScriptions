...
- **Bulk Operations**: Select and manage multiple subscriptions simultaneously
- **Search & Filter**: Find subscriptions quickly with advanced filtering options
- **Export Functionality**: Download subscription data for external analysis
- **User Preferences**: Customizable notification settings and display options
- **Secure Authentication**: JWT-based authentication with profile management

### Planned Features
- **AI-Powered Analytics**: Machine learning insights for spending optimization
- **Bank Integration**: Automatic subscription detection via Indian banking APIs
- **Account Aggregator Support**: Secure data sharing using RBI's AA framework
- **Predictive Spending**: Forecast future subscription costs and budget planning
...
- Built with passion for helping users manage their subscription expenses
